...
class Track {
  ...
  public String toString() {
    ...
    sb.append(":\n");
    if (this.getAlbum() != null) { sb.append(TK_ALBUM); sb.append(": "); sb.append(this.getAlbum()); sb.append("\n"); }
    if (this.getArtist() != null) { sb.append(TK_ARTIST); sb.append(": "); sb.append(this.getArtist()); sb.append("\n"); }
    if (this.getArtwork_Count() != null) { sb.append(TK_ARTWORK_COUNT); sb.append(": "); sb.append(this.getArtwork_Count()); sb.append("\n"); }
    if (this.getBit_Rate() != null) { sb.append(TK_BIT_RATE); sb.append(": "); sb.append(this.getBit_Rate()); sb.append("\n"); }
    if (this.getComments() != null) { sb.append(TK_COMMENTS); sb.append(": "); sb.append(this.getComments()); sb.append("\n"); }
    if (this.getCompilation() != null) { sb.append(TK_COMPILATION); sb.append(": "); sb.append(this.getCompilation()); sb.append("\n"); }
    if (this.getComposer() != null) { sb.append(TK_COMPOSER); sb.append(": "); sb.append(this.getComposer()); sb.append("\n"); }
    if (this.getDate_Added() != null) { sb.append(TK_DATE_ADDED); sb.append(": "); sb.append(this.getDate_Added()); sb.append("\n"); }
    if (this.getDate_Modified() != null) { sb.append(TK_DATE_MODIFIED); sb.append(": "); sb.append(this.getDate_Modified()); sb.append("\n"); }
    if (this.getDisc_Count() != null) { sb.append(TK_DISC_COUNT); sb.append(": "); sb.append(this.getDisc_Count()); sb.append("\n"); }
    if (this.getDisc_Number() != null) { sb.append(TK_DISC_NUMBER); sb.append(": "); sb.append(this.getDisc_Number()); sb.append("\n"); }
    if (this.getFile_Creator() != null) { sb.append(TK_FILE_CREATOR); sb.append(": "); sb.append(this.getFile_Creator()); sb.append("\n"); }
    if (this.getFile_Folder_Count() != null) { sb.append(TK_FILE_FOLDER_COUNT); sb.append(": "); sb.append(this.getFile_Folder_Count()); sb.append("\n"); }
    if (this.getFile_Type() != null) { sb.append(TK_FILE_TYPE); sb.append(": "); sb.append(this.getFile_Type()); sb.append("\n"); }
    if (this.getGenre() != null) { sb.append(TK_GENRE); sb.append(": "); sb.append(this.getGenre()); sb.append("\n"); }
    if (this.getKind() != null) { sb.append(TK_KIND); sb.append(": "); sb.append(this.getKind()); sb.append("\n"); }
    if (this.getLibrary_Folder_Count() != null) { sb.append(TK_LIBRARY_FOLDER_COUNT); sb.append(": "); sb.append(this.getLibrary_Folder_Count()); sb.append("\n"); }
    if (this.getLocation() != null) { sb.append(TK_LOCATION); sb.append(": "); sb.append(this.getLocation()); sb.append("\n"); }
    if (this.getName() != null) { sb.append(TK_NAME); sb.append(": "); sb.append(this.getName()); sb.append("\n"); }
    if (this.getPlay_Count() != null) { sb.append(TK_PLAY_COUNT); sb.append(": "); sb.append(this.getPlay_Count()); sb.append("\n"); }
    if (this.getPlay_Date() != null) { sb.append(TK_PLAY_DATE); sb.append(": "); sb.append(this.getPlay_Date()); sb.append("\n"); }
    if (this.getPlay_Date_UTC() != null) { sb.append(TK_PLAY_DATE_UTC); sb.append(": "); sb.append(this.getPlay_Date_UTC()); sb.append("\n"); }
    if (this.getSample_Rate() != null) { sb.append(TK_SAMPLE_RATE); sb.append(": "); sb.append(this.getSample_Rate()); sb.append("\n"); }
    if (this.getSize() != null) { sb.append(TK_SIZE); sb.append(": "); sb.append(this.getSize()); sb.append("\n"); }
    if (this.getTotal_Time() != null) { sb.append(TK_TOTAL_TIME); sb.append(": "); sb.append(this.getTotal_Time()); sb.append("\n"); }
    if (this.getTrack_Count() != null) { sb.append(TK_TRACK_COUNT); sb.append(": "); sb.append(this.getTrack_Count()); sb.append("\n"); }
    if (this.getTrack_ID() != null) { sb.append(TK_TRACK_ID); sb.append(": "); sb.append(this.getTrack_ID()); sb.append("\n"); }
    if (this.getTrack_Number() != null) { sb.append(TK_TRACK_NUMBER); sb.append(": "); sb.append(this.getTrack_Number()); sb.append("\n"); }
    if (this.getTrack_Type() != null) { sb.append(TK_TRACK_TYPE); sb.append(": "); sb.append(this.getTrack_Type()); sb.append("\n"); }
    if (this.getYear() != null) { sb.append(TK_YEAR); sb.append(": "); sb.append(this.getYear()); sb.append("\n"); }
    if (this.getSeason() != null) { sb.append(TK_SEASON); sb.append(": "); sb.append(this.getSeason()); sb.append("\n"); }
    if (this.getPersistent_ID() != null) { sb.append(TK_PERSISTENT_ID); sb.append(": "); sb.append(this.getPersistent_ID()); sb.append("\n"); }
    if (this.getSeries() != null) { sb.append(TK_SERIES); sb.append(": "); sb.append(this.getSeries()); sb.append("\n"); }
    if (this.getEpisode() != null) { sb.append(TK_EPISODE); sb.append(": "); sb.append(this.getEpisode()); sb.append("\n"); }
    if (this.getEpisode_Order() != null) { sb.append(TK_EPISODE_ORDER); sb.append(": "); sb.append(this.getEpisode_Order()); sb.append("\n"); }
    if (this.getHas_Video() != null) { sb.append(TK_HAS_VIDEO); sb.append(": "); sb.append(this.getHas_Video()); sb.append("\n"); }
    if (this.getTV_Show() != null) { sb.append(TK_TV_SHOW); sb.append(": "); sb.append(this.getTV_Show()); sb.append("\n"); }
    if (this.getProtected() != null) { sb.append(TK_PROTECTED); sb.append(": "); sb.append(this.getProtected()); sb.append("\n"); }
    if (this.getBPM() != null) { sb.append(TK_BPM); sb.append(": "); sb.append(this.getBPM()); sb.append("\n"); }
    if (this.getAlbum_Artist() != null) { sb.append(TK_ALBUM_ARTIST); sb.append(": "); sb.append(this.getAlbum_Artist()); sb.append("\n"); }
    if (this.getExplicit() != null) { sb.append(TK_EXPLICIT); sb.append(": "); sb.append(this.getExplicit()); sb.append("\n"); }
    if (this.getSkip_Count() != null) { sb.append(TK_SKIP_COUNT); sb.append(": "); sb.append(this.getSkip_Count()); sb.append("\n"); }
    if (this.getSkip_Date() != null) { sb.append(TK_SKIP_DATE); sb.append(": "); sb.append(this.getSkip_Date()); sb.append("\n"); }
    if (this.getRelease_Date() != null) { sb.append(TK_RELEASE_DATE); sb.append(": "); sb.append(this.getRelease_Date()); sb.append("\n"); }
    if (this.getPodcast() != null) { sb.append(TK_PODCAST); sb.append(": "); sb.append(this.getPodcast()); sb.append("\n"); }
    if (this.getMovie() != null) { sb.append(TK_MOVIE); sb.append(": "); sb.append(this.getMovie()); sb.append("\n"); }
    if (this.getUnplayed() != null) { sb.append(TK_UNPLAYED); sb.append(": "); sb.append(this.getUnplayed()); sb.append("\n"); }
    if (this.getSort_Album() != null) { sb.append(TK_SORT_ALBUM); sb.append(": "); sb.append(this.getSort_Album()); sb.append("\n"); }
    if (this.getSort_Album_Artist() != null) { sb.append(TK_SORT_ALBUM_ARTIST); sb.append(": "); sb.append(this.getSort_Album_Artist()); sb.append("\n"); }
    if (this.getSort_Artist() != null) { sb.append(TK_SORT_ARTIST); sb.append(": "); sb.append(this.getSort_Artist()); sb.append("\n"); }
    if (this.getSort_Composer() != null) { sb.append(TK_SORT_COMPOSER); sb.append(": "); sb.append(this.getSort_Composer()); sb.append("\n"); }
    if (this.getSort_Name() != null) { sb.append(TK_SORT_NAME); sb.append(": "); sb.append(this.getSort_Name()); sb.append("\n"); }
    if (this.getContent_Rating() != null) { sb.append(TK_CONTENT_RATING); sb.append(": "); sb.append(this.getContent_Rating()); sb.append("\n"); }
    if (this.getDisabled() != null) { sb.append(TK_DISABLED); sb.append(": "); sb.append(this.getDisabled()); sb.append("\n"); }
    if (this.getPurchased() != null) { sb.append(TK_PURCHASED); sb.append(": "); sb.append(this.getPurchased()); sb.append("\n"); }
    if (this.getVideo_Height() != null) { sb.append(TK_VIDEO_HEIGHT); sb.append(": "); sb.append(this.getVideo_Height()); sb.append("\n"); }
    if (this.getVideo_Width() != null) { sb.append(TK_VIDEO_WIDTH); sb.append(": "); sb.append(this.getVideo_Width()); sb.append("\n"); }
    if (this.getEID() != null) { sb.append(TK_EID); sb.append(": "); sb.append(this.getEID()); sb.append("\n"); }
    if (this.getHD() != null) { sb.append(TK_HD); sb.append(": "); sb.append(this.getHD()); sb.append("\n"); }
    if (this.getAlbum_Rating() != null) { sb.append(TK_ALBUM_RATING); sb.append(": "); sb.append(this.getAlbum_Rating()); sb.append("\n"); }
    if (this.getAlbum_Rating_Computed() != null) { sb.append(TK_ALBUM_RATING_COMPUTED); sb.append(": "); sb.append(this.getAlbum_Rating_Computed()); sb.append("\n"); }
    if (this.getRating() != null) { sb.append(TK_RATING); sb.append(": "); sb.append(this.getRating()); sb.append("\n"); }
    if (this.getGrouping() != null) { sb.append(TK_GROUPING); sb.append(": "); sb.append(this.getGrouping()); sb.append("\n"); }
    if (this.getPart_Of_Gapless_Album() != null) { sb.append(TK_PART_OF_GAPLESS_ALBUM); sb.append(": "); sb.append(this.getPart_Of_Gapless_Album()); sb.append("\n"); }
    if (this.getMusic_Video() != null) { sb.append(TK_MUSIC_VIDEO); sb.append(": "); sb.append(this.getMusic_Video()); sb.append("\n"); }
    if (this.getMatchID() != null) { sb.append(TK_MATCH_ID); sb.append(": "); sb.append(this.getMatchID()); sb.append("\n"); }
    if (this.getXID() != null) { sb.append(TK_XID); sb.append(": "); sb.append(this.getXID()); sb.append("\n"); }
    if (this.getRating_Computed() != null) { sb.append(TK_RATING_COMPUTED); sb.append(": "); sb.append(this.getRating_Computed()); sb.append("\n"); }
    if (this.getSort_Series() != null) { sb.append(TK_SORT_SERIES); sb.append(": "); sb.append(this.getSort_Series()); sb.append("\n"); }
    return sb.toString();
  }
